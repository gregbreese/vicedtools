...
if __name__ == "__main__":
    from config import (root_dir,
                        ...
                        student_details_csv,
                        student_details_table_id,
                        bucket)
    student_details_file = os.path.join(root_dir, compass_folder, student_details_folder, student_details_csv)
    compass_student_details_to_bq(student_details_table_id, bucket, student_details_file)